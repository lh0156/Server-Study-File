...
public class BookDAO {
	...
	public void test() {
		...
		String clientId = "J4W5jp0exAYzA1Ov0nMG";
		String clientSecret = "y3nC4Yckuc";
	...
	public ArrayList<BookDTO> list(String query, int start) {
		...
		String apiURL = "https://openapi.naver.com/v1/search/book.xml?query=" + text + "&start=" + start;
		...
		try {
			...
			//System.out.println(rss.getChildNodes().item(0).getChildNodes().item(4).getTextContent()); //tag.innerText > tag.textContent
	...
	public HashMap<String, Integer> getPageInfo(String query, int start2) {
		...
		String apiURL = "https://openapi.naver.com/v1/search/book.xml?query=" + text + "&start=" + start2;
