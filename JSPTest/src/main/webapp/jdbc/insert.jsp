...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    try {
    	...
    	//DBC 접속한 정보를 가지고 있는 Connection 객체 생성
    	//conn = new Connection();
    	conn = DriverManager.getConnection(url, id, pw);
		
    	//conn.setAutoCommit(true); //수동
    	...
    	//DB 작업 > insert
    	// - SQL 작성 > "SQL" 문자열로 작성
    	String sql = "insert into tblJava (id, name, age, regdate) values ('test', '테스트', 26, default)";
